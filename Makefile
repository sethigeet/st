...
SRC = st.c x.c boxdraw.c hb.c normalMode.c
OBJ = $(SRC:.c=.o)
...
install: st
	...
	cp -f scripts/st-copyoutput $(DESTDIR)$(PREFIX)/bin
	cp -f scripts/st-urlhandler $(DESTDIR)$(PREFIX)/bin
	chmod 755 $(DESTDIR)$(PREFIX)/bin/st
	chmod 755 $(DESTDIR)$(PREFIX)/bin/st-copyoutput
...
uninstall:
	...
	rm -f $(DESTDIR)$(PREFIX)/bin/st-copyoutput
